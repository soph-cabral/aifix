    ...
    for (let x = 0; x < img.width; x++) {
        for (let y = 0; y < img.height; y++) {
            ...
            if (colorCategory === 'red') {
                ...
                paintCanvas.strokeWeight(0.5);
                paintCanvas.noFill();
                paintCanvas.stroke(255,99,71, 40); // Red color
                ...
                paintCanvas.strokeWeight(1);
                //no fill
                paintCanvas.fill(255,253,208, 30);
                paintCanvas.stroke(255,196,12, 30);
                paintCanvas.translate(mappedX, mappedY);
                for (let i = 0; i < 10; i++) {
                ...
                paintCanvas.strokeWeight(1);
                paintCanvas.noFill();
                paintCanvas.stroke(119,139,165, 40);
                paintCanvas.rect(mappedX, mappedY, brushSize, brushSize * 2);
                paintCanvas.pop();
            } else if (colorCategory === 'blue') {
                // Draw blue cloud
