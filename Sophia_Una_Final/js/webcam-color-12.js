    ...
    for (let x = 0; x < img.width; x++) {
        for (let y = 0; y < img.height; y++) {
            ...
            if (colorCategory === 'red') {
                ...
                //no fill
                paintCanvas.noFill();
                paintCanvas.stroke(255, 230, 0, 40);
                paintCanvas.translate(mappedX, mappedY);
                for (let i = 0; i < 10; i++) {
                ...
                paintCanvas.push();
                let grassCount = 10;  
                let bladeWidth = max(brushSize / 20, 1); 
                let bladeHeight = brushSize; 
                ...
                for (let i = 0; i < grassCount; i++) {
                    ...
                    let bladeColor = color(53 + random(-colorVariation, colorVariation), 191 + random(-colorVariation, colorVariation), 74 + random(-colorVariation, colorVariation), 80);
                ...
                paintCanvas.noFill();
                paintCanvas.stroke(50, 50, 50, 200);
                paintCanvas.ellipse(mappedX, mappedY, brushSize, brushSize);
                paintCanvas.pop();
                ...
                paintCanvas.push();
                paintCanvas.strokeWeight(.1);
                paintCanvas.stroke(120, 120, 120, 200);
                paintCanvas.noFill(); 
